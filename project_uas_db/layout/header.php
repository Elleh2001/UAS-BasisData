...
<head>
    ...
    <title>Aplikasi Transaksi Sederhana</title>
...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Aplikasi Order  Barang</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-black sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <br>
                        <li class="nav-item">
                            <a class="nav-link active" href="data_lokasi.php">
                        ...
                        <br>
                        <li class="nav-item">
                            <a class="nav-link active" href="data_rumah.php">
                        ...
                        <br>
                        <li class="nav-item">
                            <a class="nav-link active" href="data_transaksi.php">
                                <span data-feather="file"></span>
                                Data Order
                            </a>
                        </li>
                        <br>
                        <li class="nav-item">
                            <a class="nav-link active" href="data_laporan.php">
                    ...
                    <ul class="nav flex-column mb-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="data_jns_seleski.php">
                                <span data-feather="file-text"></span>
                                Data Jenis Seleksi
                            </a>
                        </li>
